...
TORNEOS = [
    ...
    {"nombre":"FIP BRONZE BAKU II",     "ciudad":"Baku",      "bandera":"🇦🇿", "cat":"FIP BRONZE",       "id":"2717", "year":"2026"},
    {"nombre":"FIP BRONZE LA NUCIA",    "ciudad":"La Nucia",  "bandera":"🇪🇸", "cat":"FIP BRONZE",       "id":"2715", "year":"2026"},
    {"nombre":"FIP SILVER R3 BULL CUP", "ciudad":"R3 Bull",   "bandera":"🎾",  "cat":"FIP SILVER",       "id":"2716", "year":"2026"},
]
...
def ciclo():
    ...
    tg_enviar(
        ...
        "🇦🇷 Bordeaux · Baku · La Nucia · R3 Bull Cup\n\n"
        f"{LINK_WEB}"
    )
    contador = 0
    while True:
